...
public class CaterReviewsList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cater_reviews_list);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId())
                {
                    case  R.id.nav_home:
                        ...
                        Intent intent = new Intent(CaterReviewsList.this, CaterDash.class);
                    ...
                    case R.id.nav_drawer1:
                        Intent intent1 = new Intent(CaterReviewsList.this , CaterOrderList.class);
                    ...
                    case R.id.nav_drawer2:
                        Intent intent2 = new Intent(CaterReviewsList.this , AddMenuList.class);
                    ...
                    case R.id.nav_Policy:
                        Intent intent3 = new Intent(CaterReviewsList.this , RemoveMenuList.class);
