...
public class VideoCallActivity extends AppCompatActivity {
    ...
    private static final String[] REQUESTED_PERMISSIONS = {Manifest.permission.RECORD_AUDIO, Manifest.permission.CAMERA,Manifest.permission.ACCESS_NETWORK_STATE,Manifest.permission.BLUETOOTH,Manifest.permission.BLUETOOTH_CONNECT};
    ...
    public void onjoinChannelClicked() {
        mRtcEngine.joinChannel("007eJxTYJj26Gds3MPn92L5nVacM/xa/dlpfv4bn+bbMyUe3167y5VZgSHNzDjVJNXI0tw8OcXEKNnEMtHc0jTJLDnF3NTQxMjI3NPFMvnYVKtkeTZmJkYGCATx2RnS8vNTMkqTGBgAo2gjeA==",
                "foodhub", "Extra Optional Data", 0); // if you do not specify the uid, Agora will assign one.
        setupLocalVideoFeed();
        //findViewById(R.id.joinBtn).setVisibility(View.GONE); // set the join button hidden
         Log.e("comness","comes here");
    ...
    private void leaveChannel() {
        ...
        DatabaseReference database =  FirebaseDatabase.getInstance().getReference("videocall").child(getIntent().getStringExtra("usermobile")+getIntent().getStringExtra("custmobile"));
